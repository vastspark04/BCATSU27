...
public class ReorderableListElement : MonoBehaviour, IDragHandler, IEventSystemHandler, IBeginDragHandler, IEndDragHandler
{
	...
	private void RefreshSizes()
	{
		...
		float num2 = (_fakeElementLE.preferredHeight = (_draggingObjectLE.preferredHeight = sizeDelta.y));
		num2 = (_fakeElementLE.preferredWidth = (_draggingObjectLE.preferredWidth = sizeDelta.x));
	}
