...
{
	public static readonly byte[] ExpectedHeader = new byte[8] { 137, 80, 78, 71, 13, 10, 26, 10 };
	...
	public HeaderValidationResult(int byte1, int byte2, int byte3, int byte4, int byte5, int byte6, int byte7, int byte8)
	{
		...
		Byte7 = byte7;
		Byte8 = byte8;
		IsValid = byte1 == ExpectedHeader[0] && byte2 == ExpectedHeader[1] && byte3 == ExpectedHeader[2] && byte4 == ExpectedHeader[3] && byte5 == ExpectedHeader[4] && byte6 == ExpectedHeader[5] && byte7 == ExpectedHeader[6] && byte8 == ExpectedHeader[7];
	}
