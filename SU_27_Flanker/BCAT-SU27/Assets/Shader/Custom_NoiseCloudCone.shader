Shader "Custom/NoiseCloudCone" {
	Properties {
		...
		_MaxZDist ("Max Z Dist", Float) = 1
		_ConeSteep ("Cone Steepness", Float) = 1
		_ConeSharp ("Cone Sharpness", Float) = 1
		_ConeCenter ("Cone Center", Vector) = (0,0,0,0)
		_ConeFwd ("Cone Fwd", Vector) = (0,0,1,0)
	}
